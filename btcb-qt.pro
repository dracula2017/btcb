...
BOOST_INCLUDE_PATH=C:/deps64/boost_1_64_0
BOOST_LIB_PATH=C:/deps64/boost_1_64_0/stage/lib
...
LIBS += $$join(BOOST_LIB_PATH,,-L,) $$join(BDB_LIB_PATH,,-L,) $$join(OPENSSL_LIB_PATH,,-L,) $$join(QRENCODE_LIB_PATH,,-L,) $$join(LIBPNG_LIB_PATH,,-L,)

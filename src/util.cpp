...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\btcb
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\btcb
    // Mac: ~/Library/Application Support/btcb
    // Unix: ~/.btcb
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "btcb";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "btcb.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "btcbd.pid"));
